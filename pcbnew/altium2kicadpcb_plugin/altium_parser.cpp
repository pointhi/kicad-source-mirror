...
int ALTIUM_PARSER::property_int(const std::map<std::string, std::string> &properties, const std::string &key, int def) {
    try {
...
double ALTIUM_PARSER::property_double(const std::map<std::string, std::string> &properties, const std::string &key, double def) {
    try {
        const std::string &value = properties.at(key);
...
std::string ALTIUM_PARSER::property_string(const std::map<std::string, std::string> &properties, const std::string &key, std::string def) {
    try {
